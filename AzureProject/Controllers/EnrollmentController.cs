...
namespace AzureProject.Controllers
{
    public class EnrollmentController : Controller
    {
        ...
        public EnrollmentController(AzureContext context)
        {
            _context = context;
        }
        ...
        {
            var azureContext = _context.Enrollments.Include(e => e.Course);
            return View(await azureContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AzureContext.Enrollments'  is null.");
            }
            var enrollment = await _context.Enrollments.FindAsync(id);
            if (enrollment != null)
            {
